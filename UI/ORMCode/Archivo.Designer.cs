...
namespace UI.sct
{
    ...
    public partial class Archivo : XPLiteObject
    {
        int fIdArchivo;
        [Key(true)]
        public int IdArchivo
        {
            get { return fIdArchivo; }
            set { SetPropertyValue<int>(nameof(IdArchivo), ref fIdArchivo, value); }
        }
        string fNombre;
        [Size(150)]
        ...
        {
            get { return fPeso; }
            set { SetPropertyValue<long>(nameof(Peso), ref fPeso, value); }
        }
